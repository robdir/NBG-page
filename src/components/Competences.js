  ...
  render() {
    return(
        ...
        <div className="bubble-items ">
          ...
          <span className="bubble-pop-up-text"> Klantgerichtheid: Mensen die
          ...
          <div className="bubble"><p>Analytisch </p>
            <span className="bubble-pop-up-text"> Analytisch: Hoofd- en bijzaken van elkaar scheiden, dat ligt
          ...
          <div className="bubble"><p>Ondernemerschap </p>
            <span className="bubble-pop-up-text"> Ondernemerschap is supercool </span></div>
          <div className="bubble"><p>Innovatief </p>
            <span className="bubble-pop-up-text"> Innovatief is supercool </span></div>
          <div className="bubble"><p>Aanpassingsvermogen</p>
            <span className="bubble-pop-up-text"> Aanpassingsvermogen is supercool </span></div>
        </div>
        </div>
      )
    }
